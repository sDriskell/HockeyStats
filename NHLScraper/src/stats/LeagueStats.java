...
public class LeagueStats {
    ...
    private Map<String, List<PlayerStats>> baseTeams;
    private List<PlayerStats> playerObjects;
     ...
     */
    public LeagueStats(List<PlayerStats> argNhlPlayerObjects) {
    ...
    private void compileTeams() {
        ...
        List<PlayerStats> tempList;

        for (PlayerStats player : playerObjects) {
     ...
     */
    public List<PlayerStats> fetchAllStatsOnPlayer(String name) {
        List<PlayerStats> playerStatsAcrossLeague = new ArrayList<>();
     ...
     *                                player
     */
    private void parseTeamForPlayer(String name, List<PlayerStats> playerStatsAcrossLeague,
            RefinedTeamStats team) {
        for (PlayerStats player : team.getRawTeamStats().getTeamMembers()) {
